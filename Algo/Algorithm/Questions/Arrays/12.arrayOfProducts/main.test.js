...
describe('arrayOfProducts', () => {
  ...
  it('should return result', () => {
    ...
    let result = [672, -1680, 840, -240, 560]
    expect(arrayOfProducts(test.array)).toStrictEqual(result);
  });
  ...
  it('should return result', () => {
    ...
    let result = [1620, 4860, 7290, 14580, 1620, 2916, 4860, 7290]
    expect(arrayOfProducts(test.array)).toStrictEqual(result);
  });
  ...
  it('should return result', () => {
    ...
    let result = [362880, 0, 0, 0, 0, 0, 0, 0, 0, 0]
    expect(arrayOfProducts(test.array)).toStrictEqual(result);
  });
