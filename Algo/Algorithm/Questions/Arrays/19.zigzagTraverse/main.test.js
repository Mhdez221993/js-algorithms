...
describe('zigzagTraverse', () => {
  ...
  it('should return result', () => {
    ...
    const result = [1, 10, 21, -3, 11, 6, 7, 8, 112, 4, 15, 12, 113, 2, 15, 16, 17, 18, 19, 20, 6, -7, -1, 21, 22, 23, 24, 27, 226, -27, 0, -2, 88, 9, -3, 0, 12, 28, 299, 30, -28, 32, 0, -4, 0, -111, -226, 29, 32, -23, 66, -17, 31, 88];
    expect(zigzagTraverse(test.array)).toStrictEqual(result);
  });
});
